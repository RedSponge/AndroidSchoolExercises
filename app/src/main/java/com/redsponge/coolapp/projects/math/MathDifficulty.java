...
public enum MathDifficulty {
    ADD_N_SUB("Level 1 - Addition/Subtraction", 10, ADD, SUB),
    ADD_N_SUB_EXPERT("Level 2 - BIG Addition/Subtraction", 100, ADD, SUB),
    ...
    HARD("Level 728349 - BIG HARD", 50, MUL, DIV, POWER),
    ;
